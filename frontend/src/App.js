        ...
        {user?.role === 'admin' && stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">₹{(stats.orders.totalRevenue || 0).toLocaleString()}</div>
              </CardContent>
            </Card>
          </div>
        )}
...
const CartPage = () => {
  ...
  const createOrder = async () => {
    if (!cart || cart.items.length === 0) return;
         ...
         const orderData = {
       items: cart.items,
       shippingAddress: "Test Address 123" // In real app, this would be from a form
     };
  ...
  const createProduct = async (e) => {
    ...
    try {
      const productData = {
        ...
        inventory: {
          stock: parseInt(newProduct.stock_quantity)
        },
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{analytics.users.totalUsers || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{analytics.products.totalProducts || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{analytics.orders.totalOrders || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">₹{(analytics.orders.totalRevenue || 0).toLocaleString()}</div>
